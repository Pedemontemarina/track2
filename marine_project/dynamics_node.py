...
class BlueROV2DynamicsNode(Node):
    ...
    def __init__(self):
        ...
        # Dichiarati come parametri ROS2: puoi cambiarli da riga di
        # comando o da file YAML senza toccare il codice, es:
        #   ros2 run bluerov2_sim dynamics_node --ros-args -p m_rb:=12.0
        # ---------------------------------------------------------------
        ...
        self.declare_parameter('iz_rigid', 0.16)      # inerzia yaw rigida [kg m^2]
        ...
        self.I_z = gp('iz_rigid').value + gp('m_a_r').value
